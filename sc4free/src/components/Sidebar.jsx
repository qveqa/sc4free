    ...
    <div className="sidebar glass-panel">
      <div className="logo-container">
        <div className="logo-icon" style={{ display: 'flex', alignItems: 'center' }}>
          <svg fill="#ffffff" height="16" width="37" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" 
        ...
        <span className="logo-text">SC4Free</span>
      </div>
      ...
      <div style={{ marginTop: 'auto', padding: '12px 4px 4px 4px' }}>
        {userProfile ? (
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px', background: 'rgba(255,255,255,0.03)', padding: '10px', borderRadius: '10px', border: '1px solid var(--border-color)' }}>
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              ...
              <div style={{ fontSize: '10px', color: 'var(--text-secondary)' }}>Авторизован</div>
            </div>
            <button
              onClick={onLogout}
          ...
          <button
            onClick={handleLogin}
            style={{ width: '100%', padding: '12px', background: 'var(--accent-gradient)', border: 'none', borderRadius: '10px', color: 'white', fontWeight: '600', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px', cursor: 'pointer', boxShadow: '0 4px 15px var(--accent-glow)' }}
          >
